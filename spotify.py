...
def get_current_track():
    ...
    response = requests.get(
        'https://accounts.spotify.com/authorize?client_id=2b93bf2a8d9743f6aa3be61d3aea2efd&response_type=code&redirect_uri=http%3A%2F%2F192.168.1.71%3A5000%2Ffaceit&scope=user-read-currently-playing',
    ...
    req = requests.post('https://accounts.spotify.com/api/token',
                        ...
                        data={
                            ...
                            "client_id": "2b93bf2a8d9743f6aa3be61d3aea2efd",
                            "client_secret": "818292364704425ebb59b4ae1b5e5ff8"
                        }
...
def main2():
    data = {}
    response = requests.get(
        'https://open.faceit.com/data/v4/players?nickname=S1FIKS&game=csgo&game_player_id=76561198801798528',
        headers={
